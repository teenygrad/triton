...
void Pingponger::transformOnePPClusters(OpBuilder &builder, Location loc) {
  ...
  auto preDotBar = ROCDL::SchedBarrier::create(builder, loc,
...
Pingponger::transformTwoClusterWithLocalLoadAndAll(OpBuilder &builder,
  ...
  appendOp(ROCDL::SchedGroupBarrier::create(builder, loc, ROCDL::SchedGroupMask::mfma_wmma, 1, 0));
  appendOp(ROCDL::SchedGroupBarrier::create(builder, loc, ROCDL::SchedGroupMask::salu, 3, 0));
  appendOp(ROCDL::SchedGroupBarrier::create(builder, loc, ROCDL::SchedGroupMask::mfma_wmma, 1, 0));
  appendOp(ROCDL::SchedGroupBarrier::create(builder, loc, ROCDL::SchedGroupMask::salu, 3, 0));
  appendOp(ROCDL::SchedGroupBarrier::create(builder, loc, ROCDL::SchedGroupMask::mfma_wmma, 1, 0));
